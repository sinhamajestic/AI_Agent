...
export const HomeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M3 10.5v9A2.25 2.25 0 005.25 21.75h13.5A2.25 2.25 0 0021 19.5v-9" />
  </svg>
);

export const StreamIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const MeetingIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.928A9.094 9.094 0 0112 15.22a9.094 9.094 0 01-5.059 1.942 3 3 0 01-4.682-2.72m18 0a9.094 9.094 0 00-3.741-.479m0 0a3 3 0 00-4.682 2.72m6.74-3.2a9.094 9.094 0 01-3.741.479m-3.741-.479a9.094 9.094 0 013.741-.479m0 0c-1.943 0-3.722-.442-5.059-1.228a3 3 0 00-4.681 2.72 9.094 9.094 0 003.741.479m-12.059-1.942a9.094 9.094 0 015.059-1.228a3 3 0 014.681 2.72 9.094 9.094 0 01-5.059 1.228m-2.25-10.038a3.75 3.75 0 00-7.5 0 3.75 3.75 0 007.5 0zM12 4.5a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM12 12.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
  </svg>
);
...
export const BellIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.31 5.632l-1.42 2.14a23.848 23.848 0 005.455 1.31m5.714 0a23.848 23.848 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
    </svg>
);
...
export const SnoozeIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.75-13a.75.75 0 00-1.5 0v5c0 .414.336.75.75.75h4a.75.75 0 000-1.5h-3.25V5z" clipRule="evenodd" />
    </svg>
);

export const BlockIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export const EmailIcon: React.FC<IconProps> = ({ className = 'w-4 h-4' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className={className}>
    <path d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.34.227.786.227 1.126 0l6.6-3.185c.025-.012.05-.023.076-.032V4.5A1.5 1.5 0 0 0 13.5 3h-11Z" />
    <path d="M15 6.954 8.38 10.14a2.25 2.25 0 0 1-2.26 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z" />
  </svg>
);
